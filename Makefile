...
eqa2: eqa2.c
	${CC} ${CFLAGS} -o $@ $^
# eqa3 is a light testing program
eqa3: eqa3.c
	${CC} ${CFLAGS} -o $@ $^
...
# seed a random vector
seev0: seev0.c
	${CC} ${CFLAGS} -o $@ $^ -lm
# had to backtrack as usual.
seev00: seev00.c
	${CC} ${CFLAGS} -o $@ $^ -lm
